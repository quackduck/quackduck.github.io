function submit() {
  ...
  function newsubmit() {
    ...
    if (electcartotalcost<gascartotalcost) {
      document.getElementById("result").innerHTML= "TESLA WINS";
    }
    else if (electcartotalcost==gascartotalcost) {
      ...
      document.getElementById("result").innerHTML= "GAS CAR WINS and goes on to destroy earth"//<br> At " + equalyears + " years the total cost of this gas car and the Tesla is the same";
    }
